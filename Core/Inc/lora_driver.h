...
{
  void (*PrepareSensorData)(sSendDataBinary_t *PtrStruct);        /*Get measure sensor data (pressure, humidity, Temperature and current battery level)*/
...
extern TIM_HandleTypeDef *hSendCycleTimer;
extern TIM_HandleTypeDef *hProtectCycleTimer;
